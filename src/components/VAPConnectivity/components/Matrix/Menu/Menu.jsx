...
import { ALGORITHMS, SMALL_ALGORITHMS } from '@/components/VAPUtils/Constants';
...
const single_menu = [
  ...
  },
  {
    key: 3,
    label: 'Reorder',
    children: <Reorder algorithms={ALGORITHMS} />
  },
  {
    key: 4,
    label: 'Interaction',
...
const yux_menu = [
  ...
  {
    key: 2,
    label: 'Filter Matrices',
    children: <Filter />
  },
  {
    key: 3,
    label: 'Reorder Matrices',
    children: <Reorder algorithms={SMALL_ALGORITHMS} />
  },
  {
    key: 4,
    label: 'Interaction',
...
export const Menu = (props) => {
  ...
  console.log('RENDERING MATRIX MENU...');
