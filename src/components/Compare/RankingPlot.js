...
import { addFilteringVariable } from "@/features/compare/compareSlice";
import { moveTooltip } from "@/utils/functions";

export default class RankingPlot {
  constructor(parent) {
    this.parent = parent;
    this.margin = { top: 40, right: 80, bottom: 80, left: 120 };
    this.nBars = 15;
    this.pValue = 0.05;
    this.desc = true;
    this.filterList = [];
  ...
  updateVis(result, config) {
    ...
    vis.descriptions = store.getState().cantab.descriptions;
  ...
  renderVis() {
    ...
    vis.xAxisG
      ...
      .on("mouseover", function (e, d) {
        ...
        console.log(vis.filteredData, d, description);
        vis.descTooltip
          .style("opacity", 1)
