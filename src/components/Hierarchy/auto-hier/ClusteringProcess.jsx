...
import { CreateToMeta } from "@/features/metadata/metaCreatorReducer";
    ...
    <div style={{ display: "flex", alignItems: "center", flexGrow: 1 }}>
      ...
      >
        <div style={{ overflowY: "scroll", marginTop: "0.75rem", flexGrow: 1 }}>
          <p>
            Creation of Hierarchy through the use of semantic similarities
            obtained through AI techniques.
          </p>
          <CustomDetails title="Configurtion (Advanced)">
            ...
            <div style={{ marginLeft: "0.5rem" }}>
              ...
              <select
                name="hier-emb-prune"
                onChange={(event) =>
                  setPruneTress(parseFloat(event.target.value))
                }
      ...
      >
        <h3 style={{ fontWeight: "bold", color: "black", fontSize: "1.25rem" }}>
          Steps:
        </h3>
        ...
        <StatusMarker status={clusteringStatus}>
          Computing Hierarchy
        </StatusMarker>
